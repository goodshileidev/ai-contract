...
- **部署架构详细设计**: [@docs/03-架构设计/06-部署架构设计/](../06-部署架构设计/)
- **安全架构详细设计**: [@docs/03-架构设计/07-安全架构设计.md](../07-安全架构设计.md)

## 修改历史

| 日期 | 版本 | 修改者 | 修改内容概要 |
|------|------|--------|-------------|
| 2025-11-29 | 1.0 | claude-sonnet-4-5 (claude-sonnet-4-5-20250929) | 从02-技术架构设计.md拆分创建部署运维架构文档 |

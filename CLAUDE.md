...
- ✅ 使用标准化子目录：01-原则指引/ 02-需求定义/ 03-架构设计/ 04-业务设计/ 05-编码实现/ 06-测试验证/ 07-交付部署/ 99-知识积累/
- ❌ 禁止文档散落在项目根目录
...
**架构文档**:
- @docs/03-架构设计/00-架构设计总览.md
- @docs/03-架构设计/02-数据库设计.md
- @docs/03-架构设计/03-API接口设计.md
- @docs/03-架构设计/05-AI能力层设计.md
- @docs/03-架构设计/06-部署架构设计.md

**实现文档**:
- @docs/05-编码实现/task-plan.md - 开发任务计划和进度跟踪
...
| 版本 | 日期 | 变更说明 | 修订者 |
|------|------|---------|--------|
| 2.2 | 2025-11-29 | 重构文档目录结构：所有docs子目录改为语义化命名（原则指引、需求定义、架构设计、业务设计、编码实现、测试验证、交付部署、知识积累），新增06-测试验证目录 | claude-sonnet-4-5 (claude-sonnet-4-5-20250929) |
| 2.1 | 2025-11-27 | 添加文档长度限制：要求每个文档不得超过1000行，超过时应拆分为多个文档 | claude-sonnet-4-5 (claude-sonnet-4-5-20250929) |
